...
5. **Clave de respuestas**`,
  ...
  'Asistente de Idiomas': {
    ...
    subtitle: 'Inglés, español, francés, italiano, portugués y traducción contextual.',
    defaultModel: 'anthropic/claude-sonnet-4.5',
    ...
    system: SYSTEM_TEACHER + ' Eres especialista en español, inglés, francés, italiano y portugués, con contexto bilingüe Puerto Rico. Cuando traduzcas, preserva el registro y nivel apropiado al grado.',
    buildPrompt: (f) => f.pregunta,
  },
  ...
  'Asistente de ELA (Inglés)': {
    ...
    subtitle: 'Phonics, grammar and reading comprehension.',
    defaultModel: 'anthropic/claude-sonnet-4.5',
    ...
    system: SYSTEM_TEACHER + ' You are an ELA specialist K-12. You can respond in English or Spanish depending on the question. Focus on phonics, writing process, grammar in context, and reading comprehension strategies aligned to CCSS-ELA.',
    buildPrompt: (f) => f.pregunta,
  },
